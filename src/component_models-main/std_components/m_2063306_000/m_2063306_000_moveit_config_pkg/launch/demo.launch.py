...
def generate_launch_description():
    ...
    moveit_dir = get_package_share_directory('m_2063306_000_moveit_config_pkg')
    ...
    robot_description_file = os.path.join(
        moveit_dir, 'config/m_2063306_000.urdf.xacro')
    robot_description_semantic_config = load_file(
        moveit_dir, 'config/m_2063306_000.srdf')
    ...
    # RViz
    rviz_config_file = os.path.join(moveit_dir, 'launch', 'moveit.rviz')
    ...
    for controller in ['m_2063306_000_controller',
