...
def generate_launch_description():
    ...
    moveit_dir = get_package_share_directory('m_4730788_001_moveit_config_pkg')
    ...
    robot_description_file = os.path.join(
        moveit_dir, 'config/m_4730788_001.urdf.xacro')
    robot_description_semantic_config = load_file(
        moveit_dir, 'config/m_4730788_001.srdf')
    ...
    for controller in ['m_4730788_001_controller',
