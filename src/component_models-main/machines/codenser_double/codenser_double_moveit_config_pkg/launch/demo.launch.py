...
def generate_launch_description():
    ...
    moveit_dir = get_package_share_directory('codenser_double_moveit_config_pkg')
    ...
    robot_description_file = os.path.join(
        moveit_dir, 'config/codenser_double.urdf.xacro')
    robot_description_semantic_config = load_file(
        moveit_dir, 'config/codenser_double.srdf')
    ...
    robot_description = {'robot_description': Command(
        ['xacro ', robot_description_file], on_stderr="warn")}
    ...
    # for controller in ['c_203_robot_arm_controller', 'c_204_pick_place_system_controller', 'c_206_height_check_system_controller',
    #                    'c_303_robot_arm_2_controller', 'c_304_pick_place_system_2_controller', 'c_306_height_check_system_2_controller',
